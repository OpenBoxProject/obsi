...
from openbox.parsing import EthernetParsingBlock, Ipv4ParsingBlock, NopParsingBlock, TcpParsingBlock, UdpParsingBlock, \
    PayloadParsingBlock
from openbox.transformation import SingleFieldTransformator, GzipCompress, GzipDecompress
...
class TestSingleFieldTransformation(unittest.TestCase):
    def test_compression(self):
        ...
        self.assertEqual(expected_payload, metadata.header.compressed_payload)
...
class TestGzipDecompress(unittest.TestCase):
    def test_decompression(self):
        ...
        packet = 'b0487aeccc020c84dc9e9a6108004500002961a740008006678cc0a80166d4b39ad9' \
                 '19bd01bbf2d4bf217286f39a5010010249a60000789c63105432060000ae0067'.decode('hex')
        expected_payload = '00112233'.decode('hex')
        p, off, metadata = pg.process(packet, 0, Container())
        self.assertEqual(off, len(packet))
        self.assertEqual(expected_payload, metadata.header.decompressed_payload)